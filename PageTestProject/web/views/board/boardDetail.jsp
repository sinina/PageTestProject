...
<script>
		...
		function txtdd(){
			...
			var txtDOGNUM = parseInt(document.getElementById("txtDOGNUM").value);
			...
			if(days3==0){
				...
				if(txtDOGNUM>0){
					...
					daypay= 20000
					tax = (overpay+daypay+petadd)/10;
					totalprice= petadd+daypay+tax+overpay;
					
					var daypay2 = numberConvert(daypay);
					var overpay2 = numberConvert(overpay);
					var tax2 = numberConvert(tax);
					var totalprice2 = numberConvert(totalprice);
					var dayprice2 = numberConvert(dayprice);
					var petadd2 = numberConvert(petadd);
						
						
					document.getElementById("ctlADDSUM").innerHTML = petadd2+"원";
					document.getElementById("dayprice").innerHTML = daypay2+"원";
					document.getElementById("overpay").innerHTML = overpay2+"원";
					document.getElementById("tax").innerHTML = tax2+"원";
					...
					document.getElementById("ctlADDSUM").innerHTML = petadd+"원";
					document.getElementById("dayprice").innerHTML = daypay2+"원";
					document.getElementById("overpay").innerHTML = overpay2+"원";
					document.getElementById("tax").innerHTML = tax2+"원";
					document.getElementById("totalprice").innerHTML = totalprice2+"원";
		...
		$(function(){
			$('#datetimepicker5').datetimepicker().on('dp.change', function(e){
				...
				var value2 = todate.split(/[-| |:]/);
				
				var start = new Date(value[0],value[1],value[2]);
				var now = new Date(value2[0],value2[1],value2[2]);
			
				days = now.getTime() - start.getTime();
				var dayp= value2[3]-value[3];
				...
				if(days<=0){
					...
					if(dayp<0||days<0){
						...
						document.getElementById("tax").innerHTML = "3,000원";
						document.getElementById("daycare").innerHTML = "1 박";
						document.getElementById("dayprice").innerHTML = "30,000원";
						document.getElementById("overpay").innerHTML = "0원";
						document.getElementById("totalprice").innerHTML ="33,000원";
						console.log('금액 초기화')
					
					
					}else if(0<dayp&&dayp<=12){
						
						daypay = 20000
						
					
					document.getElementById("daycare").innerHTML = "1 day";
					
					
					
					if(8<=dayp&& dayp<=12){
						overpay =10000;
						tax = (overpay+daypay)/10;
						totalprice= daypay+tax+overpay;
						var daypay2 = numberConvert(daypay);
						var overpay2 = numberConvert(overpay);
						var tax2 = numberConvert(tax);
						var totalprice2 = numberConvert(totalprice);
					...
					daypay = 30000
					days3 = days / (1000 * 60 * 60 * 24);
					
					dayprice =days3*daypay;
					...
					document.getElementById("daycare").innerHTML = days3+" 박";
					...
					if(8<=dayp&& dayp<=12){
						...
						tax = (overpay+dayprice)/10
					    totalprice= dayprice+overpay+tax;
						...
						document.getElementById("dayprice").innerHTML = dayprice2+"원";
						document.getElementById("overpay").innerHTML = overpay2+"원";
						document.getElementById("tax").innerHTML = tax2+"원";
						document.getElementById("totalprice").innerHTML = totalprice2+"0원";
			 ...
			 <%if(member==null){%>
				...
				//반려동물 정보 가져오는 서블릿으로 이동
				  location.href="<%=request.getContextPath()%>/selectPetInfo.do?petsNo="
						+petsNo+"&petoNo="+petoNo+"&start="+start+"&end="+end+"&dayprice="+dayprice+ 
						 "&tax="+tax+"&overpay="+overpay+"&price="+totalprice+"&petsName="+petsName+"&petoName="+petoName;  
				} <%}%>
				return false;
		});
