		...
		<h4>기본정보</h4>
			<ul>
				...
				<li>
					...
					<span class="radio-chk">
                                        <input type="radio" id="petsitter1" name="sitterType" value="1" />
				 ...
				 <li class="large">
                                    ...
                                    <span class="radio-chk">
                                            <input type="radio" id="phone" name="openArea" value="1"/>
                                            <label for="phone">휴대폰번호</label>
                                            <input type="radio" id="kakaotalk" name="openArea" value="2"/>
                                            <label for="kakaotalk">카카오톡 ID</label>
				...
				<li class="large">
                                    ...
                                    <span class="radio-chk">
                                            <input type="radio" id="fullTime" name="fullTimeJob" value="1"/>
			...
			<h4>펫시터 소개 제목</h4>
                                <ul class="info-list none address">
                                    <li class="dub">
                                        <label>펫시터로서 나를 50자 이내로 표현해주세요. <br/> </label>
                                        <input type="text" style="width:600px;" name="adComment" value=""
                                               placeholder="강아지,고양이에 대한 애정이 깊은 펫시터입니다."/>
                                    </li>
                                </ul>
		 ...
		 <h4>펫시터 소개 (인터뷰)</h4>
                                <ul class="info-list none address interview">
                                    <li class="dub">
                                        ...
                                        <input type="text" style="width:600px;" name="opportunity" value="">
                                    </li>
                                    <li class="dub">
                                        <label>2. 펫시터 활동 이력을 말씀해주세요. 처음시작하시는 분이라면 각오를 적어주세요.</label>
                                        <input type="text" style="width:600px;" name="activityHistory" value="">
                                    </li>

                                    <li>
                                        <label style="width:245px;">3. 장기 시터링도 가능하신가요?</label>
                                        <span class="radio-chk">
                                        <input type="radio" id="yes1" name="long_term" value="0"/>
                                    ...
                                    <li>
                                        ...
                                        <span class="radio-chk">
                                        <input type="radio" id="yes2" name="pickup" value="0"/>
                                    ...
                                    <li class="dub">
                                        ...
                                        <textarea name="prContext"></textarea>
                                    </li>
                                </ul>
		...
		<h4>경력 및 활동지역</h4>
                                <ul class="info-list none address">
                                    <li>
                                        <label>펫시터 경력</label>
                                    <span>
                                        <select title="경력을 선택해주세요" name="sitterCareer">
		...
		<h4>상세정보</h4>
                                <ul class="info-list none address label-ico">
                                    ...
                                    <span class="radio-chk animal_layout"">
                                       <input type="radio" id="yes3" name="animalCheck" value="0"/>
                                    ...
                                    <span class="radio-chk">
                                        <input type="radio" id="yes4" name="child" value="0"/>
                                    ...
                                    <li>
                                        <label>감시카메라</label>
                                    <span class="radio-chk">
                                        <input type="radio" id="yes5" name="camera" value="0"/>
                                    ...
                                    <li>
                                        ...
                                        <span><input type="text" name="distance" value=""/>분 거리</span>
                                    </li>
                                    <li>
                                ...
                                <ul class="info-list none address">
                                    <li class="dub">
                                        ...
                                        <input type="text" placeholder="예금주명" name="bankName" value="" style="margin-left:10px; width:150px;"/>
                                        <input type="text" placeholder="계좌번호" name="bankNumber" value="" style="margin-left:10px; width:288px;"/>
                                    </li>
                                </ul>
		</div>
	</form>
